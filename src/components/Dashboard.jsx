...
export default function Dashboard({ mudarTela }) {
  ...
  async function salvarSegundaEtapa(event) {
    ...
    if (error) { event.currentTarget.querySelector('[data-segunda-etapa-mensagem]').textContent = `Não foi possível salvar: ${error.message}`; return }
